                ...
                <div class="row">
                    <div class="col-12">
                        <div class="wpo-section-title">
                            <span>Tous les alertes validées</span>
                            <h2>Des gens qui ont besoin de vous !</h2>
                        </div>
                    </div>
                </div>
                    <div class="wpo-section-title">
        ...
        <template v-slot:prepend>
          <q-icon name="room" />
                ...
                <div class="row" v-if="all">
                    <template  v-for="showz in showalerts.materials" class="col-md-4 col-sm-6 col-12 custom-grid">
                    ...
                    <template v-for="showz in showalerts.sangs"  class="col-md-4 col-sm-6 col-12 custom-grid">
                    ...
                    <template v-for="showz in showalerts.money"  class="col-md-4 col-sm-6 col-12 custom-grid">
                        <div  v-if="model === 'Tous' || showz.wilaya === model " :key="showz.id" class="wpo-event-item col-md-4 col-sm-6 col-12 custom-grid">
                            <div class="wpo-event-img">
                            ...
                            <div class="wpo-event-text">
                                ...
                                <p>{{showz.somme}} DA voulu</p>
                                <router-link :to="{ name: 'argent', params: { id: showz.id }}">En savoir plus...</router-link>
                            </div>
                        </div>
                    </template>
                    <template v-for="showz in showalerts.medicals"   class="col-md-4 col-sm-6 col-12 custom-grid">
                        <div  v-if="model === 'Tous' || showz.wilaya === model " :key="showz.id" class="wpo-event-item col-md-4 col-sm-6 col-12 custom-grid">
                            <div class="wpo-event-img">
                    ...
                    <template v-for="showz in showalerts.repas"  class="col-md-4 col-sm-6 col-12 custom-grid">
                        <div v-if="model === 'Tous' || showz.wilaya === model "  :key="showz.id" class="wpo-event-item col-md-4 col-sm-6 col-12 custom-grid">
                            <div class="wpo-event-img">
...
export default {
  ...
  methods: {
    ...mapActions('general', ['getalertss']),
    ...mapGetters('general', ['getalerts']),
    showLoading () {
      this.$q.loading.show({
        message: "<b>Chargement d'alertes de besoin </b>.<br/><span class='text-green'>Veuillez patienter...</span>"
      })
